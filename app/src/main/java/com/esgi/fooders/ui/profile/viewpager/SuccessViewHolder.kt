...
class SuccessViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    private val successNameTextView: TextView = itemView.findViewById(R.id.txt_ranking_username_item)
    private val successDescTextView: TextView = itemView.findViewById(R.id.txt_ranking_score_item)
